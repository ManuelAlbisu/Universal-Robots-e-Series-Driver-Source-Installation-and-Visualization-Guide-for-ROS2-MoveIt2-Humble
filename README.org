...
#+begin_src shell
  ros2 launch ur_robot_driver ur_control.launch.py ur_type:=ur5e robot_ip:=yyy.yyy.yyy.yyy launch_rviz:=true initial_joint_controller:=joint_trajectory_controller
#+end_src
